...
def _seed_admin_acct_db(app):
    ...
    if len(User.query.filter(User.first_name=="CONP Admin").all()) == 0:
        ...
        user.affiliation_type = AffiliationType.query.filter(AffiliationType.name=="OT").first()
