...
Revision ID: b4df731417f9
Revises: 
Create Date: 2019-04-03 07:25:25.783517
...
def upgrade():
    ...
    op.create_index(op.f('ix_dataset_stats_dataset_id'), 'dataset_stats', ['dataset_id'], unique=False)
    ...
    op.create_index(op.f('ix_pipelines_pipeline_id'), 'pipelines', ['pipeline_id'], unique=False)
