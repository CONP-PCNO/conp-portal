"""add github clone count table

Revision ID: b7c656425256
Revises: 3d982110f18c
Create Date: 2022-03-08 16:36:56.492771
...
def upgrade():
    ...
    op.create_table('github_daily_clone_counts',
...
def downgrade():
    ...
    op.drop_table('github_daily_clone_counts')
    # ### end Alembic commands ###
